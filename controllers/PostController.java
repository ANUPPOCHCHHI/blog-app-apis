...
import com.codewithanup.blog.payloads.ApiResponse;
import com.codewithanup.blog.payloads.PostDto;
import com.codewithanup.blog.payloads.PostResponse;
import com.codewithanup.blog.services.FileService;
...
public class PostController {
	...
	public ResponseEntity<PostDto> uploadPostImage(
		...
		PostDto postDto = this.postService.getPostById(postId);//check this name post is present or not. if id not present
																//then resourceNotFound Exception will Occur
